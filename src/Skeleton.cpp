...
public:
	class Face {
	public:
		Face(size_t idx1, size_t idx2, size_t idx3) :
...
void initObjects() {
	...
	meshes[1] = Mesh(
		...
		std::vector<vec3> {
			vec3(0.5773502588272095, 0.5773502588272095, 0.5773502588272095),
			vec3(0.5773502588272095, 0.5773502588272095, -0.5773502588272095),
			vec3(0.5773502588272095, -0.5773502588272095, 0.5773502588272095),
			vec3(0.5773502588272095, -0.5773502588272095, -0.5773502588272095),
			vec3(-0.5773502588272095, 0.5773502588272095, 0.5773502588272095),
			...
			vec3(-0.5773502588272095, -0.5773502588272095, 0.5773502588272095),
			vec3(-0.5773502588272095, -0.5773502588272095, -0.5773502588272095),
			vec3(0.35682210326194763, 0.9341723322868347, 0.0),
			vec3(-0.35682210326194763, 0.9341723322868347, 0.0),
			vec3(0.35682210326194763, -0.9341723322868347, 0.0),
			vec3(-0.35682210326194763, -0.9341723322868347, 0.0),
			vec3(0.9341723322868347, 0.0, 0.35682210326194763),
			vec3(0.9341723322868347, 0.0, -0.35682210326194763),
			vec3(-0.9341723322868347, 0.0, 0.35682210326194763),
			vec3(-0.9341723322868347, 0.0, -0.35682210326194763),
			vec3(0.0, 0.35682210326194763, 0.9341723322868347),
			vec3(0.0, -0.35682210326194763, 0.9341723322868347),
			vec3(0.0, 0.35682210326194763, -0.9341723322868347),
			vec3(0.0, -0.35682210326194763, -0.9341723322868347),
		}
